...
public class CPBlockTagGenerator extends TagsProvider<Block> {
	...
	protected void addTags() {
		...
		for(String wood:CPBlocks.woods) {
			...
			tag(BlockTags.LOGS_THAT_BURN).add(cp(wood+"_log"));
			tag(BlockTags.LOGS).add(cp(wood+"_log"));
			tag(BlockTags.PARROTS_SPAWNABLE_ON).add(cp(wood+"_log"));
			tag(BlockTags.LAVA_POOL_STONE_CANNOT_REPLACE).add(cp(wood+"_log"));
			tag(BlockTags.LOGS_THAT_BURN).add(cp(wood+"_wood"));
			tag(BlockTags.LOGS).add(cp(wood+"_wood"));
			tag(BlockTags.PARROTS_SPAWNABLE_ON).add(cp(wood+"_wood"));
			tag(BlockTags.LAVA_POOL_STONE_CANNOT_REPLACE).add(cp(wood+"_wood"));
			...
			tag(BlockTags.STAIRS).add(cp(wood+"_stair"));
			tag(BlockTags.WOODEN_STAIRS).add(cp(wood+"_stair"));
		}
	...
	private Block cp(String s) {
		return ForgeRegistries.BLOCKS.getValue(mrl(s));
	}
